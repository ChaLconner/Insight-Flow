...
const KeyMetricsComponent: React.FC<KeyMetricsProps> = ({ data, period, trends = [] }) => {
    ...
    const metrics = useMemo(() => [
        {
            ...
            trend: getTrendData('completion rate') || getTrendData('tasks completed') || { value: 5.2, direction: 'up' as const },
        },
        {
            title: 'Team Velocity',
            ...
            trend: getTrendData('project velocity') || getTrendData('team velocity') || { value: 8.1, direction: 'up' as const },
        },
        {

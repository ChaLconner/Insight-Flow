...
const WorkloadChart = lazy(() =>
  import("./WorkloadChart").then((mod) => ({ default: mod.WorkloadChart })),
);
const CreationCompletionChart = lazy(() =>
  import("./CreationCompletionChart").then((mod) => ({
    default: mod.CreationCompletionChart,
  })),
);
const StatusDistributionChart = lazy(() =>
  import("./StatusDistributionChart").then((mod) => ({
    default: mod.StatusDistributionChart,
  })),
);
const PriorityChart = lazy(() =>
  import("./PriorityChart").then((mod) => ({ default: mod.PriorityChart })),
);

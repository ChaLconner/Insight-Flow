...
const WorkloadChartComponent: React.FC<WorkloadChartProps> = ({
    ...
    const displayData = usePagination && paginatedData
        ? paginatedData.items
        : data;

    const totalCount = usePagination && paginatedData
        ? paginatedData.total
        : data.length;
                    ...
                    {usePagination && (
                        <div className="flex items-center gap-2">
                            ...
                            <Button
                                ...
                                title={sortOrder === 'desc' ? 'Sort: Highest First' : 'Sort: Lowest First'}
                            >
                                {sortOrder === 'desc' ? (
                ...
                {usePagination && paginatedData && paginatedData.total_pages > 1 && (
                    <div className="flex items-center justify-between pt-4 mt-2 border-t border-white/10">
                        <span className="text-sm text-zinc-400">
                            Page {paginatedData.page} of {paginatedData.total_pages.toLocaleString()}
                        </span>

                        ...
                        <div className="p-6 space-y-6">
                            <div className="flex flex-col items-center text-center gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-zinc-400">
                                        This action cannot be undone. This will permanently delete the project <span className="text-white font-medium">"{project?.name}"</span> and remove all associated tasks, members, and data.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <label className="text-xs font-medium text-zinc-400 uppercase">
                                    Type <span className="text-zinc-300 selectable select-all">{project?.name}</span> to confirm
                                </label>
                                <Input
                                    value={confirmName}

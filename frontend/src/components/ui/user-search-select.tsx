...
export function UserSearchSelect({ value, onChange, onUserSelect, className, placeholder }: UserSearchSelectProps) {
                        ...
                        >
                            ...
                            <div className="flex flex-col overflow-hidden">
                                <span className="text-sm font-medium text-white truncate">
                                    {user.firstName} {user.lastName} <span className="text-zinc-500 text-xs">(@{user.username})</span>
                                </span>

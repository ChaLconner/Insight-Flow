...
import { useCreateProject, useUpdateProject, useArchiveProject } from "@/hooks/use-projects";
...
export function ProjectsClient({ initialProjects }: ProjectsClientProps) {
    ...
    }, [modalMode, editingProject, createProjectMutation, updateProjectMutation, router]);

...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-72 border-r border-white/10 bg-black/40 backdrop-blur-xl transition-transform">
      <div className="flex h-full flex-col px-4 py-6">
        ...
        <div className="mt-auto border-t border-white/10 pt-6">
          <button
            onClick={() => {
              // ดึงฟังก์ชัน logoutAndRedirect จาก auth store โดยตรง

...
export function NewTaskModal({ isOpen, onClose, onTaskCreated, defaultProjectId, task }: NewTaskModalProps) {
    ...
    const getPriorityColor = (p: string) => {
        switch (p) {
            case TaskPriority.URGENT: return "text-fuchsia-400";
            case TaskPriority.HIGH: return "text-red-400";
            case TaskPriority.MEDIUM: return "text-yellow-400";
    ...
    const getStatusColor = (s: string) => {
        switch (s) {
            case TaskStatus.DONE: return "text-emerald-400";
            case TaskStatus.IN_PROGRESS: return "text-blue-400";
            case TaskStatus.IN_REVIEW: return "text-purple-400";
            case TaskStatus.CANCELLED: return "text-red-400";

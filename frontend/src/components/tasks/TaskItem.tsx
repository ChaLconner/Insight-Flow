                ...
                <CardContent className="p-4 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                        <div className={`h-2 w-2 rounded-full ${task.status.toLowerCase() === 'done' ? 'bg-emerald-500' :
                            task.status.toLowerCase() === 'in_progress' ? 'bg-blue-500' :
                                task.status.toLowerCase() === 'in_review' ? 'bg-purple-500' :
                                    task.status.toLowerCase() === 'cancelled' ? 'bg-red-500' : 'bg-zinc-500'
                            }`} />

...
export function EmptyState({
    ...
    return (
        <div
            ...
            role="status"
            aria-label={hasFilters ? "No users match your filters" : "No users in team"}
        >
            <div
            ...
            {hasFilters && (
                <p className="text-sm text-zinc-500 mt-4">
                    Tip: Press <kbd className="px-2 py-1 bg-zinc-800 rounded text-zinc-300 text-xs">/</kbd> to focus the search field
                </p>
            )}
        </div>
    );

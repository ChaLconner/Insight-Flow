...
import { ProjectsListSkeleton, ActivityFeedSkeleton } from "./components/DashboardSkeleton";

// Lazy load components to reduce initial bundle size
const RecentProjects = dynamic(() => import("./components/RecentProjects").then(mod => mod.RecentProjects), {
    loading: () => <ProjectsListSkeleton />
});
const RecentActivity = dynamic(() => import("./components/RecentActivity").then(mod => mod.RecentActivity), {

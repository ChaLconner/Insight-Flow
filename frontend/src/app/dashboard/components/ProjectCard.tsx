...
// Static class names
const PROJECT_ITEM_CLASSES = "group p-3 rounded-xl hover:bg-white/5 transition-all border border-transparent hover:border-white/5 cursor-pointer";
const ICON_CONTAINER_CLASSES = "h-12 w-12 rounded-xl flex items-center justify-center shadow-lg transition-transform group-hover:scale-105 duration-300 shrink-0";
                        ...
                        <div className="flex-1 sm:flex-none sm:w-32">
                            ...
                            <div className="h-1.5 w-full rounded-full bg-white/10 overflow-hidden">
                                <div
                                    ...
                                    style={{ width: `${projectProgress}%`, backgroundColor: projectColor }}
                                />
                            </div>
                        </div>
                        <Badge

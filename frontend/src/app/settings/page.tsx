...
const NotificationsSettings = dynamic(
  () => import("./components/notifications-settings").then((mod) => mod.NotificationsSettings),
  { loading: () => <div className="h-96 animate-pulse bg-zinc-800/50 rounded-xl" /> }
);
const SecuritySettings = dynamic(
  () => import("./components/security-settings").then((mod) => mod.SecuritySettings),
  { loading: () => <div className="h-96 animate-pulse bg-zinc-800/50 rounded-xl" /> }
);
const AppearanceSettings = dynamic(
  () => import("./components/appearance-settings").then((mod) => mod.AppearanceSettings),
  { loading: () => <div className="h-96 animate-pulse bg-zinc-800/50 rounded-xl" /> }
);
...
export default function SettingsPage() {
  ...
  // Notification State
  const [notifications, setNotifications] = useState<import("./components/notifications-settings").NotificationState>({
    email: {
      tasks: true,
      projects: true,
      mentions: true

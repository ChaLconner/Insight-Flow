...
class StripeClient:
    ...
    async def update_customer(self, customer_id: str, **kwargs) -> Customer:
        ...
        return cast(
            "Customer", await self._run_stripe(stripe.Customer.modify, customer_id, **kwargs)
        )
    ...
    async def detach_payment_method(self, payment_method_id: str) -> PaymentMethod:
        ...
        return cast(
            "PaymentMethod", await self._run_stripe(stripe.PaymentMethod.detach, payment_method_id)
        )
    ...
    async def update_subscription(self, subscription_id: str, **kwargs) -> Subscription:
        ...
        return cast(
            "Subscription",
            await self._run_stripe(stripe.Subscription.modify, subscription_id, **kwargs),
        )
    ...
    async def cancel_subscription(
        ...
        if at_period_end:
            ...
            return cast(
                "Subscription", await self._run_stripe(stripe.Subscription.delete, subscription_id)
            )
